...
urlpatterns = [
    ...
    path('', include('users.urls')) ,#     add user urlpatterns
    path('portfolios/', include('portfolios.urls')), #     add user urlpatterns
    path('charts/', include('charts.urls')), #     add user urlpatterns
]
